...
export class EditComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.params.subscribe(params => {
      ...
      this.issueService.getIssueById(this.id).subscribe((res) => {
        ...
        this.selectedValue = this.issue.severity;
  ...
  updateIssue(title, responsible, description) {
    this.issueService.updateIssue(this.id, title, responsible, description, this.selectedValue, this.selectedStatus).subscribe((res) => {
